...
/*
Andrew Hunter (ahunte3)
231
Program 2
Due Oct 3
Description:Divides a 16-bit binary number by an 8-bit binary number
*/
...
public class Divide {
    public static void main(String[] args)
    {
        ...
        String startingBinaryDividend;
        int decimalFinalAcc, decimalFinalMq;
        ...
        startingBinaryDividend = binaryDividend;
        ...
        System.out.println("is in ACC     is in MQ");
        System.out.println(" " + binaryAcc + "      " + binaryMq);
        System.out.println(" check:       binary         decimal");
        System.out.println("         " + startingBinaryDividend + "        " + decimalDividend);
        System.out.println("         /       " + binaryDivisor + "      /  " + decimalDivisor);
        System.out.println("         ----------------     ------");
        decimalFinalAcc = Integer.parseInt(binaryAcc, 2);
        decimalFinalMq = Integer.parseInt(binaryMq, 2);
        System.out.println("        " + binaryAcc + " " + binaryMq + "         " + decimalFinalMq + " R " + decimalFinalAcc);
    }
}
